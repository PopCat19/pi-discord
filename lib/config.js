...
function normalizeAgents(value) {
  ...
  for (const [agentName, agent] of Object.entries(value)) {
    ...
    normalized[agentName] = {
      ...
      defaultThinkingLevel: typeof agent.defaultThinkingLevel === "string" && THINKING_LEVELS.has(agent.defaultThinkingLevel)
 ...
 * @property {string[]} groupDmAllowlistUserIds
...
export function normalizeConfig(paths, loaded) {
  ...
  return {
    ...
    groupDmAllowlistUserIds: toStringArray(input.groupDmAllowlistUserIds),
