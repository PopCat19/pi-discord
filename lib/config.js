...
export function normalizeConfig(paths, loaded) {
	...
	return {
		...
		enableChannelMemory:
			typeof input.enableChannelMemory === "boolean"
				? input.enableChannelMemory
				: fallback.enableChannelMemory,
		globalConcurrency:
		...
		showThinkingStatus:
			typeof input.showThinkingStatus === "boolean"
				? input.showThinkingStatus
				: fallback.showThinkingStatus,
