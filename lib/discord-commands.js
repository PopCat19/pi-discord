			...
			.addSubcommand((subcommand) =>
				subcommand
					...
					.addBooleanOption((option) =>
						option
							.setName("backup")
							.setDescription("Backup memory before wiping")
							.setRequired(false),
					)
					.addChannelOption((option) =>
						option
							.setName("channel")
							.setDescription("Channel to wipe (default: current)")
							.setRequired(false),
					)
					.addBooleanOption((option) =>
						option
							.setName("keep-messages")
							.setDescription("Skip deleting messages (keep user + bot msgs)")
							.setRequired(false),
					),
			)
			.addSubcommand((subcommand) =>
